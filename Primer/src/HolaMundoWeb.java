...
public class HolaMundoWeb {
	...
	public static void main(String[] args) {
		...
		System.out.println("3. Crear rutas o controladores para responder en el navegador.");
		System.out.println("4. Preparar una pagina HTML para mostrar la informacion.");
		System.out.println("5. Probar la aplicacion en localhost y mejorar poco a poco.");
	}
}
